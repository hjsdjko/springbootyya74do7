...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"width":"100%","background":"#162A68","position":"relative"}'>
				...
				<view :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}' class="detail-list-item title">
					<view :style='{"padding":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}' class="lable">车辆状态：</view>
					<view :style='{"padding":"0px","margin":"0 0 0 40rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' class="text">{{detail.cheliangzhuangtai}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
					<view class="lable" :style='{"padding":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>预约时间：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0 0 0 40rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.yuyueshijian}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"20rpx 0","margin":"0 auto","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 40rpx)","height":"auto","order":"50"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 20rpx 20rpx","color":"rgb(255, 255, 255)","borderRadius":"4rpx","background":"#41c52b","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="userid&&isAuth('yuyuetingche','取消')" @tap="onAcrossTap('quxiaoyuyue','','','[1]','已取消')" class="cu-btn bg-brown round shadow-blur" >取消</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 20rpx 20rpx","color":"rgb(255, 255, 255)","borderRadius":"4rpx","background":"#41c52b","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('yuyuetingche','取消')" @tap="onAcrossTap('quxiaoyuyue','','','[1]','已取消')" class="cu-btn bg-brown round shadow-blur" >取消</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 20rpx 20rpx","color":"rgb(255, 255, 255)","borderRadius":"4rpx","background":"#41c52b","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="userid&&isAuth('yuyuetingche','入场')" @tap="onAcrossTap('cheliangruchang','','','cheliangzhuangtai','已入场',cheliangzhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >入场</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 20rpx 20rpx","color":"rgb(255, 255, 255)","borderRadius":"4rpx","background":"#41c52b","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('yuyuetingche','入场')" @tap="onAcrossTap('cheliangruchang','','','cheliangzhuangtai','已入场',cheliangzhuangtaiCrossSelect[0])" class="cu-btn bg-brown round shadow-blur" >入场</button>
	...
	export default {
		data() {
			return {
				...
				hasNext: true,
				user: {},
                cheliangzhuangtaiCrossSelect:'已入场,待入场'.split(','),
				count: 0,
				timer: null,
				title:'',
			}
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('yuyuetingche', this.id);
