	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('cheweileixing', this.id);
                this.detail = res.data;
				this.title = this.detail.cheweileixing
            }
		},
		destroyed: function() {
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','cheweileixing');
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','cheweileixing');
			...
			async init(){
				...
				let res = await this.$api.info('cheweileixing', this.id);
				this.detail = res.data;
