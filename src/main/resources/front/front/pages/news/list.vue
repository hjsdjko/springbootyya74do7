	...
	<view class="content">
		<view :style='{"padding":"20rpx  0  120rpx 0px","background":"#162A68","flexDirection":"column","display":"flex","width":"100%","position":"relative","height":"auto"}'>
			...
			<view :style='{"padding":"0 20rpx","margin":"20rpx 0","flexWrap":"wrap","background":"#162A68","display":"flex","position":"relative","height":"auto"}'>
				<scroll-view scroll-y="true" class="category-two" :style='{"width":"22%","margin":"0 30rpx 0 0","height":"100%"}'>
				...
				<!-- 样式1 -->
				<view class="news-box1" :style='{"padding":"20rpx","margin":"20rpx 0","borderRadius":"16rpx ","background":"url(http://codegen.caihongy.cn/20240109/e55ad0424ffc411ea70c3b1536864c1d.png)  no-repeat  top / 100% auto,rgba(225,225,225,0.5) ","flex":"1","minWidth":"100%","height":"auto"}'>
					<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"boxShadow":"none","padding":"10rpx","margin":"0 0 20rpx","borderRadius":"40rpx","flexWrap":"wrap","background":"linear-gradient(to right,#FFFFFF  70%,#2DD7F9)","display":"flex","width":"100%","height":"auto"}'>
					  <view class="list-item-body" :style='{"padding":"0","margin":"0","flexWrap":"wrap","display":"flex","width":"60%","height":"auto","order":"1"}'>
						<view :style='{"padding":"0 20rpx","margin":"0","color":"#000000","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"400"}' class="title ">{{product.title}}</view>
						<view :style='{"padding":"0 20rpx","overflow":"hidden","color":"#666","display":"-webkit-box","width":"100%","lineHeight":"1.5","fontSize":"24rpx","text-overflow":"ellipsis","-webkit-box-orient":"vertical","-webkit-line-clamp":"2","fontWeight":"400"}' class="text ">{{product.introduction}}</view>
						<view :style='{"padding":"0 00 20rpx","order":"1"}'>
						...
						<view :style='{"padding":"0 20rpx","order":"1"}'>
							<text class="icon iconfont icon-geren16" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"18rpx","color":"#666"}'></text>
							<text :style='{"color":"#666","lineHeight":"1.5","fontSize":"18rpx"}'>{{product.name}}</text>
						</view>
						<view :style='{"padding":"0 20rpx","display":"inline-block"}'>
							<text class="icon iconfont icon-zan10" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"18rpx","color":"#666"}'></text>
							<text :style='{"color":"#666","lineHeight":"1.5","fontSize":"18rpx"}'>{{product.thumbsupnum}}</text>
						</view>
						<view :style='{"padding":"0 20rpx","display":"inline-block"}'>
							<text class="icon iconfont icon-shoucang10" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"18rpx","color":"#666"}'></text>
							<text :style='{"color":"#666","lineHeight":"1.5","fontSize":"18rpx"}'>{{product.storeupnum}}</text>
						</view>
						<view :style='{"padding":"0 20rpx","display":"inline-block"}'>
							<text class="icon iconfont icon-chakan9" :style='{"margin":"0 4rpx 0 0","lineHeight":"1.5","fontSize":"18rpx","color":"#666"}'></text>
							<text :style='{"color":"#666","lineHeight":"1.5","fontSize":"18rpx"}'>{{product.clicknum}}</text>
						</view>
					  </view>
					  <image :style='{"width":"100rpx","margin":"8% 0 0 0","objectFit":"cover","borderRadius":"100%","display":"block","height":"100rpx"}' mode="aspectFill" class="listmpic" :src="baseUrl+product.picture"></image>
					</view>
				</view>
