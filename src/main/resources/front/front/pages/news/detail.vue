		...
		<view class="container" :style='{"width":"100%","background":"#162A68","position":"relative"}'>
            <view :style='{"borderRadius":"40rpx 40rpx 0 0","flexWrap":"wrap","background":"none","display":"flex","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
					<view class="lable" :style='{"padding":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>标题：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0 0 0 40rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.title}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
					<view class="lable" :style='{"padding":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>分类名称：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0 0 0 40rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.typename}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
					<view class="lable" :style='{"padding":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>发布人：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0 0 0 40rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.name}}</view>
				</view>
				...
				<view :style='{"padding":"20rpx  40rpx","margin":"0 0 20rpx  40rpx","borderColor":"#ccc","borderRadius":"0 0 0 24rpx","borderWidth":"0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(50% - 40rpx)","borderStyle":"solid","height":"auto","order":"4"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="zan">
					<view :style='{"padding":"0 20rpx 0 0","color":"#333","borderRadius":"40rpx 0 0 40rpx","textAlign":"right","background":"linear-gradient(to right,#2DE4FB, #2254DB)","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx"}' class="lable">赞：</view>
					<view :style='{"width":"100%","flex":"1","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"padding":"0 80rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#000000","borderRadius":"0  40rpx  40rpx 0","background":"linear-gradient(to left, #2254DB 100%,#2DE4FB 0%)"}'>{{detail.thumbsupnum}}</view>
						<view :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#333","display":"none"}' class="cuIcon-appreciate"></view>
					</view>
				</view>
				<view :style='{"padding":"20rpx  40rpx","margin":"0 0 20rpx  40rpx","borderColor":"#ccc","borderRadius":"0 0 0 24rpx","borderWidth":"0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(50% - 40rpx)","borderStyle":"solid","height":"auto","order":"4"}' class="detail-list-item" v-if="thumbsupFlag" @tap="zan">
					<view :style='{"padding":"0 20rpx 0 0","color":"#333","borderRadius":"40rpx 0 0 40rpx","textAlign":"right","background":"linear-gradient(to right,#2DE4FB, #2254DB)","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx"}' class="lable">已赞：</view>
					<view :style='{"width":"100%","flex":"1","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"padding":"0 80rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#000000","borderRadius":"0  40rpx  40rpx 0","background":"linear-gradient(to left, #2254DB 100%,#2DE4FB 0%)"}'>{{detail.thumbsupnum}}</view>
						<view :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#333","display":"none"}' class="cuIcon-appreciate"></view>
					</view>
				</view>
				<view :style='{"padding":"20rpx 20rpx","margin":"0 20rpx 20rpx 0","borderColor":"#ccc","borderRadius":"0 0 24rpx 0 ","borderWidth":"0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(50% - 40rpx)","borderStyle":"solid","height":"auto","order":"5"}' class="detail-list-item" v-if="!thumbsupFlag&&!crazilyFlag" @tap="cai">
					<view :style='{"padding":"0 20rpx 0 0","color":"#000000","borderRadius":"40rpx 0 0 40rpx","textAlign":"right","background":"#BFBFBF","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx"}' class="lable">踩：</view>
					<view :style='{"width":"100%","flex":"1","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"padding":"0 80rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#000000","borderRadius":"0 40rpx  40rpx 0","background":"#BFBFBF"}'>{{detail.crazilynum}}</view>
				...
				<view :style='{"padding":"20rpx 20rpx","margin":"0 20rpx 20rpx 0","borderColor":"#ccc","borderRadius":"0 0 24rpx 0 ","borderWidth":"0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(50% - 40rpx)","borderStyle":"solid","height":"auto","order":"5"}' class="detail-list-item" v-if="crazilyFlag" @tap="cai">
					<view :style='{"padding":"0 20rpx 0 0","color":"#000000","borderRadius":"40rpx 0 0 40rpx","textAlign":"right","background":"#BFBFBF","width":"160rpx","lineHeight":"80rpx","fontSize":"28rpx"}' class="lable">踩：</view>
					<view :style='{"width":"100%","flex":"1","justifyContent":"space-between","display":"flex","height":"auto"}'>
						<view :style='{"padding":"0 80rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#000000","borderRadius":"0 40rpx  40rpx 0","background":"#BFBFBF"}'>{{detail.crazilynum}}</view>
						<view style="transform: rotate(180deg);" :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#333","display":"none"}' class="cuIcon-appreciate"></view>
				...
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
					<view class="lable" :style='{"padding":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>简介</view>
					<view class="text" :style='{"padding":"0px","margin":"0 0 0 40rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.introduction}}</view>
				</view>


				<view class="detail-list-item rich" :style='{"padding":"6rpx 20rpx","margin":"0 auto","borderColor":"#ccc","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"2"}'>
