...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"width":"100%","background":"#162A68","position":"relative"}'>
				...
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
					<view class="lable" :style='{"padding":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>停车时长：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0 0 0 40rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.tingcheshizhang}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
					<view class="lable" :style='{"padding":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>总费用：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0 0 0 40rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.zongfeiyong}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
					<view class="lable" :style='{"padding":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>出场时间：</view>
					<view  class="text" :style='{"padding":"0px","margin":"0 0 0 40rpx","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.chuchangshijian}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"6rpx 20rpx","borderColor":"#ccc","margin":"0 auto","flexWrap":"wrap","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,0.5)","display":"flex","width":"calc(100% - 80rpx)","borderStyle":"solid","height":"auto","order":"1"}'>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"20rpx 0","margin":"0 auto","flexWrap":"wrap","background":"none","display":"flex","width":"calc(100% - 40rpx)","height":"auto","order":"50"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 20rpx 20rpx","color":"rgb(255, 255, 255)","borderRadius":"4rpx","background":"#2152DB","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx","order":"2"}' @tap="onPayTap" v-if="userid&&isAuth('cheliangchuchang','支付') && detail.ispay!='已支付'"  class="cu-btn bg-brown round shadow-blur">支付</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 20rpx 20rpx","color":"rgb(255, 255, 255)","borderRadius":"4rpx","background":"#2152DB","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx","order":"2"}' @tap="onPayTap" v-if="!userid&&isAuthFront('cheliangchuchang','支付') && detail.ispay!='已支付'"  class="cu-btn bg-brown round shadow-blur">支付</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 20rpx 20rpx","color":"rgb(255, 255, 255)","borderRadius":"4rpx","background":"#2152DB","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx","order":"2"}' v-if="!isAuth('cheliangchuchang','支付') && detail.ispay!='已支付'" class="cu-btn bg-brown round shadow-blur">未支付</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 20rpx 20rpx","color":"rgb(255, 255, 255)","borderRadius":"4rpx","background":"#2152DB","display":"inline-block","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx","order":"2"}' v-if="detail.ispay=='已支付'"  class="cu-btn bg-brown round shadow-blur">已支付</button>
	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('cheliangchuchang', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','cheliangchuchang');
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','cheliangchuchang');
			...
			async init(){
				...
				let res = await this.$api.info('cheliangchuchang', this.id);
				this.detail = res.data;
