		...
		<view :style='{"padding":"20rpx  0  120rpx 0px","background":"#162A68","flexDirection":"column","display":"flex","width":"100%","position":"relative","height":"auto"}'>
			<view class="cu-bar bg-white search" :style='{"padding":"4rpx","margin":"0  20rpx","borderRadius":"20rpx","background":"rgba(255,255,255,0)","display":"flex","height":"auto"}'>
				...
				<view :style='{"margin":"0 12rpx 0 0","position":"relative","flex":"1","height":"100rpx"}' v-if="queryIndex==0" class="search-form round">
					...
					<input :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","color":"#666","borderRadius":"40rpx","background":"#fff","width":"100%","lineHeight":"100%","fontSize":"28rpx","height":"100%"}' v-model="searchForm.yonghuzhanghao" type="text" placeholder="用户账号" ></input>
				</view>
			...
			<view class="uni-product-list" :style='{"padding":"120rpx 20rpx  0 20rpx","margin":"0 ","borderRadius":"16rpx 16rpx","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240110/32684fc98f5f4a79a7b03f8dc479f388.png)  no-repeat  top / 100% auto,rgba(225,225,225,0.5) ","flex":"1","display":"flex","width":"73%","justifyContent":"space-between","height":"auto"}'>
				<view @tap="onDetailTap(product)" class="uni-product" :style='{"margin":"0 0 20rpx","backgroundColor":"#fff","borderRadius":"20rpx","flexWrap":"wrap","background":"linear-gradient(to bottom, #2DF1FD, #2148D9)","display":"flex","width":"48%","overflow-x":"hidden","position":"relative","height":"auto"}' v-for="(product,index) in list" :key="index">
					<view class="uni-product-title" :style='{"padding":"4rpx 20rpx","color":"#FFFFFF","width":"100%","lineHeight":"1.4","fontSize":"32rpx","fontWeight":"400","order":"1"}'>用户姓名:{{product.yonghuxingming}}</view>
					<image :style='{"padding":"0","margin":"20rpx","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"calc(100% - 40rpx)","height":"260rpx","order":"2"}' mode="aspectFill" class="uni-product-image" v-if="preHttp(product.touxiang)" :src="product.touxiang.split(',')[0]"></image>
					<image :style='{"padding":"0","margin":"20rpx","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"calc(100% - 40rpx)","height":"260rpx","order":"2"}' mode="aspectFill" class="uni-product-image" v-else :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
					<view class="uni-product-title" :style='{"padding":"4rpx 20rpx","color":"#FFFFFF","width":"100%","lineHeight":"1.4","fontSize":"32rpx","fontWeight":"400","order":"1"}'>车牌号:{{product.chepaihao}}</view>
