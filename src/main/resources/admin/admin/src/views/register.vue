	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230805/7915a0067dde42b286859569f586368e.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":"1px solid #f6f6f6","minHeight":"720px","padding":"50px 20px 20px","boxShadow":"0 6px 20px rgba(0, 0, 0, .2)","margin":"120px 0","borderRadius":"0px","textAlign":"center","background":"#fff","width":"660px","fontSize":"16px","position":"relative","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"padding":"0px","margin":"0px auto 50px","borderColor":"#eee","color":"#fff","display":"inline-block","top":"-80px","left":"-30%","background":"none","borderWidth":"0px","width":"160%","lineHeight":"40px","fontSize":"42px","position":"absolute","borderStyle":"solid","fontWeight":"600"}' class="title">基于微信小程序的停车场管理系统注册</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 10px","textAlign":"left","width":"60%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='yonghu'">
					<div v-if="true" :style='{"padding":"0 8px","color":"#666","textAlign":"right","left":"-120px","width":"120px","lineHeight":"40px","fontSize":"16px","position":"absolute"}' class="lable" :class="changeRules('yonghudianhua')?'required':''">用户电话：</div>
				...
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 10px","textAlign":"left","width":"60%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='yonghu'">
					<div v-if="true" :style='{"padding":"0 8px","color":"#666","textAlign":"right","left":"-120px","width":"120px","lineHeight":"40px","fontSize":"16px","position":"absolute"}' class="lable" :class="changeRules('chepaihao')?'required':''">车牌号：</div>
					<el-input  v-model="ruleForm.chepaihao"  autocomplete="off" placeholder="车牌号"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"padding":"0 0px","margin":"0 auto 10px","textAlign":"left","width":"60%","fontSize":"inherit","position":"relative","height":"auto"}' class="list-item" v-if="tableName=='yonghu'">
					<div v-if="true" :style='{"padding":"0 8px","color":"#666","textAlign":"right","left":"-120px","width":"120px","lineHeight":"40px","fontSize":"16px","position":"absolute"}' class="lable" :class="changeRules('chepaizhaopian')?'required':''">车牌照片：</div>
                    <file-upload
                        tip="点击上传车牌照片"
                        action="file/upload"
                        :limit="3"
                        ...
                        @change="yonghuchepaizhaopianUploadChange"
                    ></file-upload>
				</el-form-item>
...
export default {
	...
	methods: {
        ...
        yonghuchepaizhaopianUploadChange(fileUrls) {
