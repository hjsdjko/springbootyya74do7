	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="用户电话" prop="yonghudianhua">
					<el-input v-model="ruleForm.yonghudianhua" placeholder="用户电话" clearable  :readonly="ro.yonghudianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="用户电话" prop="yonghudianhua">
...
var objcross = this.$storage.getObj('crossObj');
    ...
    chepaizhaopianUploadChange(fileUrls) {
        ...
        this.$http({
            url: "yonghu/baidu/ocr?fileName="+fileUrls.substr(fileUrls.lastIndexOf("/")+1), 
            method: "get", 
            params: {} 
        }).then(({ 
            data 
