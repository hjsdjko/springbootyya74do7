	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="入场时间" prop="ruchangshijian">
					<el-input v-model="ruleForm.ruchangshijian" placeholder="入场时间" clearable  :readonly="ro.ruchangshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="入场时间" prop="ruchangshijian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="停车时长" prop="tingcheshizhang">
					<el-input-number v-model="ruleForm.tingcheshizhang" placeholder="停车时长" :readonly="ro.tingcheshizhang"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="停车时长" prop="tingcheshizhang">
					<el-input v-model="ruleForm.tingcheshizhang" placeholder="停车时长" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="出场时间" prop="chuchangshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.chuchangshijian" 
						type="datetime"
						:readonly="ro.chuchangshijian"
						placeholder="出场时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.chuchangshijian" label="出场时间" prop="chuchangshijian">
					<el-input v-model="ruleForm.chuchangshijian" placeholder="出场时间" readonly></el-input>
				</el-form-item>
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `cheliangchuchang/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.cheliangchuchangCrossAddOrUpdateFlag = false;
											this.parent.search();
